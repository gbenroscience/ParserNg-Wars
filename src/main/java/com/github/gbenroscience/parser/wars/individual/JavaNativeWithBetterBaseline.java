...
mvn clean verify -U
Run with:
java -jar target/benchmarks.jar ".*JavaNativeWithBetterBaseline.*" 
 * @author GBEMIRO
 */
...
@Threads(1)
public class JavaNativeWithBetterBaseline {
    ...
    @Benchmark
    public void nativeJavaBetterBaseline(Blackhole bh) {
        nextInput();
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(JavaNativeWithBetterBaseline.class.getSimpleName())
                .warmupIterations(5)
